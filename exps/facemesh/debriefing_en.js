        ...
        { // page begins
            ...
            questions: [
                { // question begins
                    type: 'textNumber',
                    name: 'red',
                    stem: 'What was the number of red stimuli that appeared in the task where you were asked to count the red objects?',
                    required: true,
                    errorMsg: {
                ...
                { // question begins
                    type: 'textNumber',
                    name: 'green',
                    stem: 'What was the number of green stimuli that appeared in the task where you were asked to count the green objects?',
                    required: true,
                    errorMsg: {
                        required: 'Please answer this question!!'
                    }
               ...
               { // question begins
                    type: 'textarea',
                    name: 'shapes',
                    stem: 'Which shapes appeared in the experiment?',
                    rows: 3,
                    required: true,
                    errorMsg: {
                        required: 'Please answer this question'
